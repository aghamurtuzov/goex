                ...
                <div class="card">
                    ...
                    <div class="row p-2">
                        <div class="col-md-12 text-right">
                            <a class="local-stock-sections" href="{{route("getSubSections",['id' => 0])}}">
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a href="{{route("getSectionEdit",$result->id)}}" class="dropdown-item"><i
                                                            class="icon-pencil5"></i>Edit</a>
                                                    <a href="#" class="dropdown-item"><i class="icon-list"></i>Bölmələr</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
