        ...
        <div class="card" style="max-width: 1200px;margin: auto;">
           @includeIf('partials.session-message')
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="card-body">
                        <form id="form" action="{{route("postUserPasswordEdit",[ 'id' => $user->id ])}}" method="post" class="users-content">
                            @csrf
                            <fieldset class="mb-3">
                                <legend class="text-uppercase font-size-sm font-weight-bold">Parolu Redaktə Et</legend>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">Şifrə</label>
                                    <div class="col-lg-9">
                                        <input type="password" name="password" class="form-control" placeholder="Şifrə">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">Təkrar Şifrə</label>
                                    <div class="col-lg-9">
                                        <input type="password" name="password_confirmation" class="form-control" placeholder="Şifrə">
                                    </div>
                                </div>
                            </fieldset>
