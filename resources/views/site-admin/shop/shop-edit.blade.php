        ...
        <div class="card shop">
           @includeIf('partials.session-message')
            <div class="card-body">
                ...
                <form id="form" action="{{route("postEditShop",['id' => $result->id ?? 0])}}" method="post"
                      class="users-content" enctype="multipart/form-data">
                    @csrf
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="az" role="tabpanel">
                            <fieldset class="mb-3">
                                <legend class="text-uppercase font-size-sm font-weight-bold">Mətn</legend>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input required type="text" class="form-control" value="{{ $result->title_az ?? "" }}"
                                               name="title_az" placeholder="Başlıq">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                        ...
                        <div class="tab-pane fade" id="ru" role="tabpanel">
                            <fieldset class="mb-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <input  required type="text" class="form-control" value="{{ $result->title_ru ?? "" }}"
                                               name="title_ru"
                                               placeholder="Başlıq">
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="en" role="tabpanel">
                            <fieldset class="mb-3">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Başlıq</label>
                                    <div class="col-lg-12">
                                        <input required type="text" class="form-control" value="{{ $result->title_en ?? "" }}"
                                               name="title_en"
                                               placeholder="Başlıq">
                                    </div>
                                </div>
