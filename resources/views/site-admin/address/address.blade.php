                ...
                <div class="card">
                    <div class="row p-4">
                        ...
                        <div class="col-md-6 text-right">
                            <h5 class="card-title" style="font-size: 20px;"><a href="{{route("getAddressEdit",0)}}"><button class="btn btn-primary">Əlavə Et</button></a></h5>
                        </div>
                    </div>
                     <form class="p-3"
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="country" value="{{ request()->input('country') }}"
                                   class="form-control">
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="{{route("getAddressEdit",$result->id)}}" class="dropdown-item"><i
