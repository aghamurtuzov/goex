    ...
    <div class="content pt-4 pb-4">
        <div class="card shop">
            ...
            <div class="card-body">
                ...
                <form id="form" action="{{route("postSliderEdit",['id' => $result->id ?? 0])}}" method="post" class="users-content" enctype="multipart/form-data">
                    @csrf
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="az" role="tabpanel">
                            <fieldset class="mb-3">
                                <legend class="text-uppercase font-size-sm font-weight-bold">Slayd</legend>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input required type="text" class="form-control" value="{{ $result->title_az ?? "" }}" name="title_az" placeholder="Title Az">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                        ...
                        <div class="tab-pane fade" id="ru" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input required type="text" class="form-control" value="{{ $result->title_ru ?? "" }}" name="title_ru" placeholder="Title Ru">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                        ...
                        <div class="tab-pane fade" id="en" role="tabpanel">
                            <fieldset class="mb-3">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input required type="text" class="form-control" value="{{ $result->title_en ?? "" }}" name="title_en" placeholder="Title En">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <div class="content">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        <textarea required name="content_en" id="editor-full-en" rows="4" cols="4">{{ $result->content_en ?? "" }}</textarea>
                                                    </div>
