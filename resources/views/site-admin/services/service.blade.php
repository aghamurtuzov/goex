        ...
        <div class="row">
            <div class="content">
                ...
                <div class="card">
                    <div class="row p-4">
                        <div class="col-md-6">
                            <h5 class="card-title" style="font-size: 20px;">Xidmətlər</h5>
                        </div>
                        <div class="col-md-6 text-right">
                            <h5 class="card-title" style="font-size: 20px;"><a href="{{route("getServiceEdit",0)}}"><button class="btn btn-primary">Əlav
                                    ə Et</button></a></h5>
                        </div>
                    </div>
                     <form class="p-3"
                                  action="{{ route('getModuleSearch',['module'=> 'service','mainPath' => 'site-admin', 'path' => 'services','viewFile'=>'service' ]) }}"
                                  method="GET">
                                @csrf
                                  <div class="row">
                   <div class="col-md-4">
                    ...
                    <table class="table datatable-basic text-center">
                        ...
                        @foreach($results as $result)
                            <tr>
                                ...
                                @includeIf('partials.status', ['id' => $result->id,'status' => $result->status,'module' => 'services'])
                                <td>
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="{{route("getServiceEdit",$result->id)}}" class="dropdown-item"><i
                                                        class="icon-pencil5"></i>Redaktə Et</a>
                                                <a href="javascript:void(0)" data-id="{{ $result->id }}"
                                                   data-module="services" class="dropdown-item deleteModal"><i
