        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-4">
                    <div class="nav flex-column shop_active nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        @foreach($categorys as $category)
                        <a class="nav-link category" id="{{$category->id}}" data-toggle="pill" href="#v-pills-home">{{$category->name_az}}</a>
                            @endforeach
                    </div>
                </div>
