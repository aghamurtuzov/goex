        ...
        <div class="m-slider" data-component='{ "type": "Slider" , "pagination": false, "navigation": true }' >
            <div class="m-slider__swiper swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div id="banner-{{$slider->id}}" data-ga-id="1757,All" data-ga-name="banner" data-ga-creative="samsung-galaxy-s20-kampanyasi" data-ga-position="{{$slider->id}}" data-ga-event-label="Banner-/anasayfa" data-background="{{Storage::url($slider->image)}}" class="swiper-slide swiper-lazy background-position-center">
                        <div class="m-grid">         <div class="m-grid">             <div class="m-carousel__desc m-carousel__desc--text-shadow"><h3 data-animation="slideInLeft"><span>{{$slider->title_az}}</span></h3>
                                    <h3 data-animation="slideInLeft">{{$slider->content_az}}</h3></div></div></div> </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">{{$service->title_az}}</h5>
                            <p class="card-text">{{substr($service->content_az,0,100)}}...</p>
                        </div>
                    </div>
                </div>
                @endforeach
                    ...
                    <div class="col-md-4">
                        <div class="order_count_block">
                            ...
                            <div class="order_count_text">
                                <h5>{{$annotation->title_az}}</h5>
                                <p>{!!$annotation->content_az!!}</p>
                            </div>
                        </div>
                    </div>
                        @php
