            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="#" class="dropdown-item english active"><img
                            src="{{asset("/admin/assets/global_assets/images/lang/gb.png")}}" class="img-flag" alt="">
                        English</a>
                    <a href="#" class="dropdown-item ukrainian"><img
                            src="{{asset("/admin/assets/global_assets/images/lang/ua.png")}}" class="img-flag" alt="">
                        Українська</a>
                    <a href="#" class="dropdown-item deutsch"><img
                            src="{{asset("/admin/assets/global_assets/images/lang/de.png")}}" class="img-flag" alt="">
                        Deutsch</a>
                    <a href="#" class="dropdown-item espana"><img
                            src="{{asset("/admin/assets/global_assets/images/lang/es.png")}}" class="img-flag" alt="">
                        España</a>
                    <a href="#" class="dropdown-item russian"><img
                            src="{{asset("/admin/assets/global_assets/images/lang/ru.png")}}" class="img-flag" alt="">
                        Русский</a>
                </div>
            </li>
        ...
        <div class="sidebar-content">
            ...
            <div class="card card-sidebar-mobile">
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item">
                        <a href="{{route("getAbout")}}" class="nav-link"><i class="icon-info22"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{route("getCondition")}}" class="nav-link"><i class="icon-airplane3"></i> <span>Daşınma Şərtləri</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{route("getContact")}}" class="nav-link"><i class="icon-phone-incoming"></i> <span>Bizimlə Əlaqə</span></a>
                    </li>
                    <li class="nav-item">
